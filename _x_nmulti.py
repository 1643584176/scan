# -*- coding: utf-8 -*-
"""N 线补充: 一次性 deny 全部私有/保留网段 -> 数据层验证 (multi-CIDR)
确认 deniedCIDRs 对全部私有网段 (172.31/16, 10/8, 100.64/10, 192.168/16, 169.254/16) 均不执行
"""
...
# deny 全部私有/保留网段 (同 _x_nfinal.py P1 配置, 加 readback)
body = {
    "mode": "custom",
