...
HelpWizard = {
	...
	LoadPageFromHash: function( fresh_page_load, url, link_click, search_text ) {
		...
		{
			window.location = "https://help.steampowered.com/en/login" + wizard_url.slice( 5 );
			return;
		}
		...
		{
			if ( link_click )
				history.pushState( {wizard_url: wizard_url}, '', wizard_url == 'Home' ? 'https://help.steampowered.com/en/' : 'https://help.steampowered.com/en/wizard/' + wizard_url );
			else
				history.replaceState( {wizard_url: wizard_url, search_term: search_text }, '', wizard_url == 'Home' ? 'https://help.steampowered.com/en/' : 'https://help.steampowered.com/en/wizard/' + wizard_url );
		}
		...
		$J.ajax( {
			url: 'https://help.steampowered.com/en/wizard/' + wizard_url,
			type: 'GET',
	...
	SubmitRefundRequest: function( help_issue, appid, transid, gid_line_item, refund_to_wallet, spoofing ) {
		...
		$J.ajax( {
			url: 'https://help.steampowered.com/en/wizard/AjaxSubmitRefundRequest/',
			type: 'POST',
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
	...
	CancelHelpRequest: function( reference_code, transid, gid_line_item )
	{
		ShowConfirmDialog(
			...
			$J.ajax( {
				url: 'https://help.steampowered.com/en/wizard/AjaxCancelHelpRequest/' + reference_code,
				type: 'POST',
				data: $J.extend( {}, g_rgDefaultWizardPageParams, {
		...
		$J.ajax( {
			url: 'https://help.steampowered.com/en/wizard/AjaxPackagePurchaseReceipt/',
			type: 'GET',
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
				transid: transid,
			...
			$Term.on( 'keyup paste change', function( event ) {
				...
				if ( sNewVal != sLastVal )
				{
					if ( HelpWizard.m_bUseHistoryAPI )
					{
						...
						var strFullURL = ( strSearchBaseURL == 'Home' ? 'https://help.steampowered.com/en/' : 'https://help.steampowered.com/en/wizard/' + strSearchBaseURL ) + strQuery;
	...
	DoUserSearch: function( time_last_keyup, appid )
    	{
    		if ( time_last_keyup == this.m_nLastKeyPressTimeMS )
    		{
    			...
    			$J.ajax({
                			type: "GET",
                			url: "https://help.steampowered.com/en/wizard/ScamUserSearch/",
                			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
                				text: text,
                				appid: appid
                			} )
	...
	SearchSupportFAQs: function( text, method )
	{
		...
		$J.ajax({
			type: "GET",
			url: "https://help.steampowered.com/en/wizard/AjaxSearchResults/",
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
				text: text,
				method: method,
				l: g_strLanguage
	...
	CheckConfirmationState: function() {
		$J.ajax({
			type: "GET",
			url: "https://help.steampowered.com/en/wizard/AjaxRefundRequestConfirmation",
			data: $J.extend({}, g_rgDefaultWizardPageParams, {
	...
	ShowRefundRequestForm: function( issueid, appid, packageid, transid, refund_to_wallet, loading_div ) {
		...
		$J.ajax({
			type: "GET",
			url: "https://help.steampowered.com/en/wizard/AjaxRefundRequestForm",
			data: $J.extend({}, g_rgDefaultWizardPageParams, {
				issueid: issueid,
				appid: appid,
				packageid: packageid,
	...
	ShowGiftRefundRequestForm: function( gid_guestpass ) {
		...
		$J.ajax({
			type: "GET",
			url: "https://help.steampowered.com/en/wizard/AjaxGiftRefundRequestForm",
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
	...
	MarkGiftRefundableChange: function( gid_guestpass, gid_giftcard ) {
		...
		$J.ajax( {
			url: 'https://help.steampowered.com/en/wizard/AjaxMarkGiftRefundable/',
			type: 'POST',
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
				gid_guestpass: gid_guestpass,
	...
	SubmitPasswordChangeRSA: function( strSessionID, nAccountID, rsa ) {
		...
		$J.ajax({
			...
			if ( data.hash )
			{
				window.location = 'https://help.steampowered.com/en/' + data.hash;
			}
			else if ( data.html )
			{
				HelpWizard.SetPageContent( data.html );
	...
	UpdatePhoneChina: function( strSessionID, nAccountID, strUpdateToken ) {
		...
		$J.ajax({
			type: "POST",
			url: "https://help.steampowered.com/en/wizard/AjaxAccountRecoveryUpdatedPhoneChina/",
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
				s: strSessionID,
				account: nAccountID,
	...
	ResetTwoFactor: function( strSessionID, nAccountID, nLost )
	{
		...
		$J.ajax({
			type: "POST",
			url: "https://help.steampowered.com/en/wizard/AjaxAccountRecoveryResetTwoFactor/",
			data: {
				sessionid: g_sessionID,
				s: strSessionID,
				account: nAccountID,
	...
	BindRelated: function( strSessionID, nAccountID, eReset, unIssueID ) {
		$J.ajax({
			type: "POST",
			url: "https://help.steampowered.com/en/wizard/AjaxAccountRecoveryBindRelated",
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
				s: strSessionID,
				account: nAccountID,
				reset: eReset,
	...
	SubmitProofOfPurchase: function( strSessionID, eReset, nLost ) {
		...
		$J.ajax({
			...
			if ( data.success )
			{
				window.location = "https://help.steampowered.com/en/wizard/HelpWithLoginInfoReset/?s=" + strSessionID +
	...
	RefreshCaptcha: function( nUsage, bIsRecoverySearch = false )
	{
		...
		return new Promise( ( resolve ) => {
			const fnRefreshCaptchaWhenReady = () => {
				...
				$J.ajax({
					type: "POST",
					url: "https://help.steampowered.com/en/wizard/RefreshCaptcha",
	...
	UpdateCaptcha: function( data )
	{
		...
		if ( data.gid != -1 )
		{
			...
			if ( data.type == 1 ) {
				...
				$J( '#captchaImg' ).attr( 'src', 'https://help.steampowered.com/en/login/rendercaptcha/?gid=' + data.gid );
			} else if ( data.type == 2 ) {
	...
	{
		$J.ajax({
			url: 'https://help.steampowered.com/en/login/getmenuactions/',
			type: 'GET',
	...
	DoGuestAuth: function( token )
	{
		$J.ajax( {
			...
			data: {
				'nonce': token,
				'redir': 'https://help.steampowered.com/en//wizard/HelpWithPurchase'
			},
			crossDomain: true,
			...
			.done( function( data )
			{
				...
				else
				{
					...
					window.location = 'https://help.steampowered.com/en/wizard/HelpWithPurchase';
				}
			});
	},
...
function Logout()
{
	var $Form = $J('<form/>', {'action': 'https://help.steampowered.com/en/login/logout/', 'method': 'POST' } );
...
function LogoutToAccountRecovery()
{
	$J.ajax({
		type: 'POST',
		url: 'https://help.steampowered.com/en/login/logout/',
	...
	.done( function( data )
	{
		document.location = 'https://help.steampowered.com/en/wizard/HelpWithLogin/';
	});
}
...
function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	...
	$J.post( 'https://help.steampowered.com/en/login/setlanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			if ( bStayOnPage )
				Modal.Dismiss();
			else
...
{
	$J.ajax( {
		url: 'https://help.steampowered.com/en/wizard/AjaxCancelPendingPurchase/',
		type: 'POST',
		data: $J.extend( {}, g_rgDefaultWizardPageParams, {
			transid: transid
		} )
...
{
	$J.ajax( {
		url: 'https://help.steampowered.com/en/wizard/AjaxCancelAccountDeletion/',
		type: 'POST',
		data: g_rgDefaultWizardPageParams,
	} ).fail( function( jqxhr ) {
		ShowAlertDialog( 'Cancel Account Deletion', 'Could not contact the servers to cancel account deletion. Please try again or <a href="https://help.steampowered.com/en/wizard/HelpDeleteAccountRequest" target="_blank" rel="">contact Steam Support</a>.' );
	} ).done( function( data ) {
		if ( data.success != 1 )
		{
			ShowAlertDialog( 'Cancel Account Deletion', 'Could not contact the servers to cancel account deletion. Please try again or <a href="https://help.steampowered.com/en/wizard/HelpDeleteAccountRequest" target="_blank" rel="">contact Steam Support</a>.' );
		...
		else
		{
			...
			.done( function() {
				window.location = 'https://help.steampowered.com/en/';
			});
		}
	} );
}
...
{
	$J.ajax( {
		url: 'https://help.steampowered.com/en/wizard/AjaxCancelSteamChinaAccessDeletion/',
		type: 'POST',
		data: g_rgDefaultWizardPageParams,
	} ).fail( function( jqxhr ) {
		ShowAlertDialog( 'Cancel Steam China Access and Information Deletion', 'Could not contact the servers to cancel the request. Please try again or <a href="https://help.steampowered.com/en/wizard/HelpDeleteAccountRequest" target="_blank" rel="">contact Steam Support</a>.' );
	} ).done( function( data ) {
		if ( data.success != 1 )
		{
			ShowAlertDialog( 'Cancel Steam China Access and Information Deletion', 'Could not contact the servers to cancel the request. Please try again or <a href="https://help.steampowered.com/en/wizard/HelpDeleteAccountRequest" target="_blank" rel="">contact Steam Support</a>.' );
...
HardwareRMA = {
	...
	ShowForm: function( method, issueid, appid, packageid, transid, refund_to_wallet, loading_div ) {
		...
		$J.ajax({
				type: "GET",
				url: "https://help.steampowered.com/en/wizard/" + method,
				data: $J.extend( {}, g_rgDefaultWizardPageParams, {
					issueid: issueid,
					appid: appid,
					packageid: packageid,
	...
	VerifySerialThenAdvance: function( serial_number ) {
		...
		if ( input_valid )
		{
			$J.ajax({
				type: "POST",
				url: "https://help.steampowered.com/en/wizard/AjaxVerifySerialNumber",
				data: $J.extend( {}, g_rgDefaultWizardPageParams, {
	...
	CreateReturn: function( refund_to_wallet ) {
		...
		$J.ajax({
				type: "POST",
				url: "https://help.steampowered.com/en/wizard/AjaxHardwareCreateReturn",
				data: $J.extend( {}, g_rgDefaultWizardPageParams, {
	...
	ValidateReturnShippingAddress: function() {
		...
		{
			this.m_bDoingAjax = true;
			Shipping_VerifyShippingAddress( g_sessionID, 'https://help.steampowered.com/en/wizard/AjaxVerifyShippingAddress', {
	...
	SubmitReplacementRMA: function() {
		...
		$J.ajax({
				type: "POST",
				url: "https://help.steampowered.com/en/wizard/AjaxHardwareCreateReplacementRMA",
				data: $J.extend( {}, g_rgDefaultWizardPageParams, {
					issueid: this.m_nRefundIssueID,
					appid: this.m_nRefundAppID,
					packageid: this.m_nRefundPackageID,
...
HelpRequestPage = {
	...
	{
		$J.ajax( {
			url: 'https://help.steampowered.com/en/wizard/AjaxReopenHelpRequest/' + reference_code,
			type: 'POST',
			data: $J.extend( {}, g_rgDefaultWizardPageParams, {
				reference_code: reference_code,
				help_request_page: 1
...
function SubmitUpdateShippingAddress()
{
	...
	$J.ajax({
		type: "POST",
		url: "https://help.steampowered.com/en/wizard/AjaxUpdateShippingAddress",
		method: 'post',
		data: {
