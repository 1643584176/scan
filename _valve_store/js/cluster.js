...
Cluster.BuildClusterCapsule = function( unAppID, unPackageID, strStatus, strFeature, nDepth, rgItemInfo )
{
	...
	{
		$CapCtn.append( $J('<img/>', {'class': 'cluster_capsule_image', src: 'https://store.st.dl.eccdnx.com/public/images/v6/home/maincap_placeholder_616x353.gif', 'data-image-url': rgItemData.main_capsule } ) );
	}
	else
	{
