...
function UpdateStoreBannerForAdditionalCartDiscount( nCartDiscount )
{
	...
	<div class="placeHolder_lunarSale2019_giftActiveBar">	\
		...
		<div class="lunar_sale_title"><img src="https://store.st.dl.eccdnx.com/public/images/promo/lunar2019/lny2019_title_en.png"/></div> \
...
function BuildCreatorCapsuleToAppend( oItem )
{
	...
	$FollowLink.bind('updateFollowState', function () {
		...
		{
			$FollowLink.html( '<span><img src="https://store.st.dl.eccdnx.com/public/images/v6/ico/ico_selected_green.png">Following</span>' );
