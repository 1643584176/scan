# 标题 必填
title: Figma livegraph unauthenticated PlanByFileKey leaks full billing Plan (stripeCustomerId/VAT) of any org with a public file
# 资产 必填
Asset: https://www.figma.com (livegraph WebSocket: wss://www.figma.com/api/livegraph)
# 严重程度 必填
Severity: HIGH
# 弱点 必填
...
Description
    ...
    ⭐ 核心证据(付费 pro 团队 Themesberg/Flowbite,全匿名获取):
    - stripeCustomerId: "cus_J1xwCSokJo6SMU"
    - vatGstId: "RO42244256"(真实欧盟 VAT 号)
    - taxIdVerificationStatus: "verified"
    - PlanSubscription: {status: "active", createdAt: "2021-02-28"} — 活跃订阅
    - 年合同续约日期: ANNUAL_CONTRACT_RENEWAL_DATE = "2027-02-28T18:30:37Z"
...
# 附件 非必填
Attachments:
    - flowbite_plan_clean.txt (本目录,主证据:完整 Plan + PlanSubscription + 续约日期原始帧)
    - m3_plan_clean.txt (本目录,补充证据:第二个独立案例原始帧)
