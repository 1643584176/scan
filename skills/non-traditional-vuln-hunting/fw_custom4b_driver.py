# -*- coding: utf-8 -*-
"""D 线: custom4b 驱动 - resume fwcustom1 (custom) -> 并行 payload 探测"""
...
GUEST = 'fw_custom4b_guest.py'
OUTF = 'fwcustom4b.out'
MARK = 'FWCUSTOM4B_DONE'
...
print('set custom policy:', c, r[:150], flush=True)
time.sleep(3)
