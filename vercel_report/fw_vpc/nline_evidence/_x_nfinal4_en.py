# -*- coding: utf-8 -*-
"""N-line strict comparison: does deniedCIDRs actually enforce? (base64 probe avoids quoting pitfalls)
A: custom+allow (no deny)  -> PG 172.31.0.2:5432 / HTTP 172.31.0.2:80 / curl pub
B: +deny 172.31.0.0/16     -> same as A (readback)
C: +deny 3.234.68.0/24     -> curl pub (readback)
D: deny-all                -> PG (control)
"""
