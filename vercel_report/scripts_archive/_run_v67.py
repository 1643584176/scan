# -*- coding: utf-8 -*-
"""v67 驱动: 单次 sandbox 会话完成 ①沙箱进程侦察 ②无 pid ns 容器 + cell API 全方法探测"""
...
PAY = r'D:\scan\skills\non-traditional-vuln-hunting\vda67_probe_guest.py'
...
def main():
    ...
    inject(sid, '/vercel/sandbox/vda67_probe_guest.py', PAY)
    time.sleep(1)
