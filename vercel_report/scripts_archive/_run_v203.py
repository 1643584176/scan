# -*- coding: utf-8 -*-
"""v203 驱动: init.sock 签名材料调查 (沙箱用户视角)"""
...
NAME = 'v203'
PAY = r'D:\scan\skills\non-traditional-vuln-hunting\vda203_probe_user.py'
...
def main():
    ...
    inject(sid, '/vercel/sandbox/vda203_probe_user.py', open(PAY, 'rb').read())
    c, r = cmd(sid, 'python3', ['/vercel/sandbox/vda203_probe_user.py'], 90000)
    print('[run payload]', c)
    print((r or '')[:30000])
