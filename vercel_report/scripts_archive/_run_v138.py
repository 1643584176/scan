...
NAME = 'v138'
GUEST = r'D:\scan\skills\non-traditional-vuln-hunting\vda138_guest.py'
PAY = r'D:\scan\skills\non-traditional-vuln-hunting\vda138_probe_guest.py'
...
def main():
    ...
    inject(sid, '/vercel/sandbox/vda138_guest.py', open(GUEST, 'rb').read())
    inject(sid, '/vercel/sandbox/vda138_probe_guest.py', open(PAY, 'rb').read())

    c, r = cmd(sid, 'python3', ['/vercel/sandbox/vda138_guest.py'], 300000)
    print('[run guest]', c)
    print((r or '')[:25000])

    c, r = cmd(sid, 'sh', ['-c', 'cat /vercel/sandbox/v138c.out 2>&1'], 20000)
    print('[v138c.out]', c)
    print((r or '')[:40000])
