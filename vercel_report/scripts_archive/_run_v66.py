# -*- coding: utf-8 -*-
"""v66 驱动: 单次 sandbox 会话完成 ①沙箱进程侦察 ②无 pid ns 容器 + cell API 全方法探测"""
...
NAME = 'v66'
GUEST = r'D:\scan\skills\non-traditional-vuln-hunting\vda66_guest.py'
PAY = r'D:\scan\skills\non-traditional-vuln-hunting\vda66_probe_guest.py'
...
def main():
    ...
    inject(sid, '/vercel/sandbox/vda66_probe_guest.py', PAY)
    time.sleep(1)
