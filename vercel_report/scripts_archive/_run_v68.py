# -*- coding: utf-8 -*-
"""v68 驱动: 单次 sandbox 会话完成 ①沙箱进程侦察 ②无 pid ns 容器 + cell API 全方法探测"""
...
NAME = 'v68'
GUEST = r'D:\scan\skills\non-traditional-vuln-hunting\vda68_guest.py'
PAY = r'D:\scan\skills\non-traditional-vuln-hunting\vda68_probe_guest.py'
...
def main():
    ...
    inject(sid, '/vercel/sandbox/vda68_probe_guest.py', PAY)
    time.sleep(1)
