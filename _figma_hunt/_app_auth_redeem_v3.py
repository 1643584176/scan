...
tests = [
    ('GET ?g_secret=', 'https://www.figma.com/api/session/app_auth/redeem?g_secret=' + g, 'GET', None),
    ('POST gSecret', 'https://www.figma.com/api/session/app_auth/redeem', 'POST', {'gSecret': g}),
    ('POST token', 'https://www.figma.com/api/session/app_auth/redeem', 'POST', {'token': g}),
]
for label, url, method, body in tests:
    s, h, b = call(url, method, body, base)
