"""LibrarySubscriptionView(orgId→库订阅 fileKey) + PublishedHubFileForFile(fileKey→hubFileId) 匿名测试"""
import sys, json, asyncio
import websockets
sys.stdout.reconfigure(encoding="utf-8", errors="replace")
UA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36"
ORG = "1484997479016537761"        # Demo Org
M3 = "CYs4jJGyYeUxpAVcJ2EAZ4"      # M3 Design Kit 真实 fileKey
...
def lg_url():
    return (f"wss://www.figma.com/api/livegraph?pv=1&pr=251c5be83e6853e5&pt=1786072093"
            ...
            f"&clientUrl=https%3A%2F%2Fwww.figma.com%2Ffile%2F{M3}"
        ...
        async with websockets.connect(lg_url(),
            ...
            await ws.send(json.dumps({"messageType": "auth", "clientType": "web",
                                      ...
                                      "tags": {"clientType": "web",
                                               ...
                                               "clientUrl": f"https://www.figma.com/file/{M3}"},
...
async def main():
    await sub("LibrarySubscriptionView→DemoOrg", "LibrarySubscriptionView", {"orgId": ORG})
    await sub("PublishedHubFileForFile→M3", "PublishedHubFileForFile", {"fileKey": M3})
